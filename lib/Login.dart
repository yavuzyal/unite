...
class _LoginPage2 extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //appBar: AppBar(
      //  title: Text("Login Page"), backgroundColor: Colors.lightBlueAccent, centerTitle: true,
      //),
      body: Center(
        child: Form(
          key: _formKey,
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: new Text("Sign Up", style: TextStyle(fontSize: 16, color: Colors.blue, fontWeight: FontWeight.bold), ),
                    )
                  ],
                ),
              ],
