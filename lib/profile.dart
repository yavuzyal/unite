          ...
          BottomAppBar(
            ...
            Padding(
              ...
              child: Row(
                ...
                children:[
                  Icon(Icons.map_outlined, color: AppColors.bottomBarLogoColor, size: 40,),
                Icon(Icons.search_outlined, color: AppColors.bottomBarLogoColor, size: 40),
                Icon(Icons.person_outline, color: AppColors.bottomBarLogoColor, size: 40),
                Icon(Icons.chat_outlined, color: AppColors.bottomBarLogoColor, size: 40),
                Icon(Icons.settings_outlined, color: AppColors.bottomBarLogoColor, size: 40),
              ]
              ),
            ),
          ),
